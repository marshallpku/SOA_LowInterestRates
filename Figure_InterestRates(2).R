...
labs <- c("10-year Treasury yield", "Private average discount rate", "State-local average discount rate")
...
gtitle1 <- "Discount rates and risk-free returns"
gtitle2 <- "Public and private retirement systems"
xlab <- "Pension fund fiscal year"
src <- "\nNotes:
- Public plan data for 2001+ from Public Plans Database, Center for Retirement Research. Earlier years from multiple sources.
- Private plan data provided via correspondence with authors of:
